...
public class StockPriceApiImplTest {
	...
	DataTableContainer body = new DataTableContainer();
	...
	public void getStockData_VerifyApiCall() {
		...
		String expectedUrl = "http://localhost:8080/WIKI/PRICES.json?ticker=MSFT,AAPL&date.gte=2017-01-01&date.lte=2017-02-01&qopts.columns=ticker,date,open,close,low,high,volume&api_key=XYZ";
